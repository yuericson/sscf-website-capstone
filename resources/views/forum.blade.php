...
.forum-landing-page {
  ...
  align-items: center;
  text-align: center;
  background: linear-gradient(145deg, #185F43, #0A210F); /* Dark green gradient */
  color: white;
  padding: 40px 20px;
...
.forum-landing-page .content {
  position: relative;
  z-index: 2;
}

.forum-landing-page h1 {
  font-size: 3rem;
...
.forum-landing-page .paragraph-container {
  font-size: 1.4rem;
  line-height: 1.8;
...
.forum-highlights {
  background: #F6F9F6; /* Light background for contrast */
  padding: 50px 20px;
}
...
.forum-cta {
  background: linear-gradient(145deg, #185F43, #156737);
  color: white;
  padding: 50px 20px;
}
...
.forum-cta .btn-primary {
  background-color: #F8B400; /* Golden color for contrast */
  border: none;
  font-size: 1.1rem;
  padding: 12px 30px;
  border-radius: 5px;
...
.forum-cta .btn-primary:hover {
  background-color: #E6A700; /* Darker golden color */
...
@media (max-width: 768px) {
  ...
  .forum-highlights h2, .forum-cta h2 {
    font-size: 2rem;
  }
...
<!-- Forum Landing Page -->
<section class="forum-landing-page">
  <div class="overlay"></div>
  <div class="content">
    <h1>Welcome to the SLSU Forum</h1>
    <p class="mt-3 lead paragraph-container">
      Join the conversation! Discuss topics, share ideas, and engage with the vibrant SLSU community. 
      This forum is a space where students, faculty, and alumni come together to foster meaningful connections, 
      share experiences, and explore ideas that matter.
    </p>
    <p class="mt-3 lead paragraph-container">
      Whether you're looking to exchange academic insights, discuss campus news, or simply connect with peers, 
      the SLSU Forum is the perfect platform to make your voice heard. Be part of an inclusive and supportive 
      environment that promotes collaboration and growth.
    </p>
  </div>
</section>

<section class="forum-highlights">
  <div class="container">
    <h2>Why Join the SLSU Forum?</h2>
    <div class="row">
      <div class="col-md-4">
        <div class="highlight-box">
          <i class="fas fa-comments text-primary"></i>
          <h4>Engaging Discussions</h4>
          <p>Participate in meaningful discussions and share your insights on various topics.</p>
        </div>
      </div>
      <div class="col-md-4">
        <div class="highlight-box">
          ...
          <p>Engage with fellow students, faculty, and alumni to expand your network.</p>
        </div>
      </div>
      <div class="col-md-4">
        <div class="highlight-box">
          ...
          <h4>Share Ideas</h4>
          <p>Bring your ideas to life by collaborating with the SLSU community.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="forum-cta text-center">
  <div class="container">
    <h2>Ready to Join the Forum?</h2>
    <p>Be part of the Southern Luzon State University's growing online community.</p>
    <a href="{{ Auth::check() ? route('posts') : route('login.google') }}" class="btn btn-primary">Go to Forum</a>
  </div>
</section>
