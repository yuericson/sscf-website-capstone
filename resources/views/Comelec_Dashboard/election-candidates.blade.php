...
<div class="main-content p-4" id="mainContent">
    <h2 class="mb-4 border-bottom pb-2">Candidates Management</h2>

    @php
        // We need both positions and candidates
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #137547; color: white; padding: 10px;">
            <h5 style="margin: 0; vertical-align: middle;">Manage Candidates</h5>
        ...
        <div class="card-body">
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th style="background-color: #D3D3D3; color: black; vertical-align: middle;">ID</th>
                        <th style="background-color: #D3D3D3; color: black; vertical-align: middle;">Candidate Name</th>
                        <th style="background-color: #D3D3D3; color: black; vertical-align: middle;">Position</th>
                ...
                <tbody>
                    @foreach ($candidates as $candidate)
                        <tr>
                            ...
                            <td>{{ $positions->firstWhere('id', $candidate->position_id)->name ?? 'Unknown' }}</td>
                            <td>
                                <!-- Edit Button -->
                                <button 
                                ...
                                <button 
                                    ...
                                    data-bs-toggle="modal" 
                                    data-bs-target="#deleteCandidateModal{{ $candidate->id }}"
                                >
                                    Delete
                                </button>
                            </td>
                        ...
                        <div class="modal fade" id="deleteCandidateModal{{ $candidate->id }}" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
