...
.wrapper-container {
  padding: 50px;
  text-align: center;
  background: linear-gradient(145deg, #0A210F, #14591D); /* Subtle gradient */
  box-shadow: 0 10px 30px rgba(0, 0, 0, 0.3);
  color: #E1E289; /* Light green text */
}
...
.flex-row {
  ...
  align-items: stretch; /* Ensures boxes align with equal height */
  gap: 20px; /* Spacing between boxes */
  flex-wrap: wrap; /* Allows wrapping for mobile view */
}

/* Icon Circle Styles */
.icon-container-mission, .icon-container-vision, .icon-container-goals {
  width: 90px;
  height: 90px;
  background: radial-gradient(circle, #185F43 0%, #14591D 80%);
  border: 4px solid #E1E289;
  border-radius: 50%;
  display: flex;
  justify-content: center;
  align-items: center;
...
.icon-container-mission:hover, .icon-container-vision:hover, .icon-container-goals:hover {
  transform: scale(1.2);
  box-shadow: 0 12px 25px rgba(0, 0, 0, 0.4);
}

/* Icon Styles */
.icon-container-mission i, .icon-container-vision i, .icon-container-goals i {
  font-size: 42px;
  color: #FCE7D9; /* Soft pink icons */
}

/* Box Styles */
.card-mission, .card-vision, .card-goals {
  background: linear-gradient(135deg, #14591D, #185F43);
  border-radius: 20px;
  padding: 30px;
  color: #E1E289; /* Light green text */
...
.card-mission:hover, .card-vision:hover, .card-goals:hover {
  transform: translateY(-10px);
  box-shadow: 0 12px 30px rgba(0, 0, 0, 0.4);
  background: linear-gradient(135deg, #185F43, #14591D); /* Darker hover effect */
}
...
.box-heading {
  font-size: 1.8rem;
  font-weight: bold;
  color: #FCE7D9; /* Soft pink text */
  margin-top: 15px;
  margin-bottom: 15px;
  font-family: 'Poppins', sans-serif;
  text-shadow: 1px 1px 6px rgba(0, 0, 0, 0.2); /* Subtle text shadow */
}
...
<div class="wrapper-container">
  <h2 class="title-header">Mission, Vision & Goals</h2>
  <div class="flex-row">
    <div class="card-mission">
      <div class="icon-container-mission">
        <i class="bi bi-bullseye"></i>
      </div>
      <h3 class="box-heading">Mission</h3>
      <p class="box-paragraph">The SSCF aims to empower students by serving as the primary voice of the student body, promoting welfare, rights, and involvement in institutional governance.</p>
    </div>
    <div class="card-vision">
      <div class="icon-container-vision">
        <i class="bi bi-eye"></i>
      </div>
      <h3 class="box-heading">Vision</h3>
      <p class="box-paragraph">The Supreme Student Council Federation envisions a unified and empowered student body, driven by strong leadership, inclusivity, and active participation in university affairs.</p>
    </div>
    <div class="card-goals">
      <div class="icon-container-goals">
        <i class="bi bi-flag"></i>
      </div>
      <h3 class="box-heading">Goals</h3>
      <p class="box-paragraph">To establish a dynamic and inclusive student community by promoting academic growth, leadership, and engagement in shaping university policies and initiatives.</p>
    </div>
  </div>
</div>
