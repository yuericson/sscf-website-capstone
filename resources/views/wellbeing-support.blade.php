...
<head>
  ...
  <title>Well-being Support</title>
...
<style>
 /* Well-Being Support Section Styles */
.well-being-support-container {
  border-radius: 20px; /* Rounded corners */
  margin-top: -40px;
  margin-bottom: -10px;
  padding: 25px; /* Add some padding for content spacing */

}

.well-being-support-title {
  font-size: 2.8rem; /* Larger title font */
  color: #14591D; /* Dark green for title */
  margin-bottom: 25px;
  text-align: center; /* Center the title */
  font-weight: bold; /* Make the title stand out */
}

.well-being-support-card {
  background: #E1E289; /* Light yellow card background */
  border: none; /* No border */
  border-radius: 15px; /* Rounded corners for cards */
  display: flex;
  align-items: center; /* Align items in the center vertically */
  padding: 25px; /* Add padding to the card */
  margin: 20px 15px; /* Add margin to separate cards */
  box-shadow: 0 6px 8px rgba(0, 0, 0, 0.15); /* Subtle shadow for depth */
}

.well-being-support-card img {
  ...
  border: 2px solid #0A210F; /* Add a border for emphasis */
}

.well-being-support-card-title {
  font-size: 1.85rem; /* Card title font size */
  color: #14591D; /* Consistent title color */
  margin-bottom: 20px; /* Space below title */
  text-align: center; /* Center align title */
  font-weight: bold; /* Bold title for emphasis */
}

.well-being-support-card-text {
  color: #0A210F; /* Darker green for text */
...
.well-being-notices li {
  padding: 12px 0; /* Space between list items */
  position: relative; /* Positioning for icons */
  text-align: left; /* Align text to left */
  color: #0A210F; /* Text color for notices */
  font-size: 1.1rem; /* Slightly larger text */
}

.well-being-notices li::before {
  content: '✔'; /* Checkmark icon for each item */
  color: #14591D; /* Icon color */
  position: absolute; /* Position absolute to align properly */
  left: -40px; /* Adjust this value for spacing */
  font-size: 1.6rem; /* Icon size */
  line-height: 1; /* Center the icon vertically */
}

.well-being-support-card .col-md-6.order-md-1 {
  padding-left: 50px; /* Adjust the value to shift the text slightly to the right */
}

.well-being-support-card .col-md-6.order-md-2 {
  padding-right: 40px; /* Ensure the image stays balanced on the right */
}
...
@media (max-width: 768px) {
  .well-being-support-container {
      padding-left: 25px; /* Add larger left padding for mobile */
      padding-right: 25px; /* Add larger right padding for mobile */
  }
  ...
  .well-being-support-card {
      ...
      padding: 25px; /* Ensure there's padding for mobile view */
      margin: 15px 0; /* Ensure margin for separation */
  }

  .well-being-support-card img {
      max-width: 85%; /* Slightly reduce image width on mobile */
      max-height: 250px; /* Reduce image height on mobile */
  }

  .well-being-support-card-title {
      font-size: 1.6rem; /* Smaller card title on mobile */
  }

  .well-being-support-card-text {
      margin-bottom: 18px; /* Adjust spacing below text */
  }

  .well-being-support-card .col-md-6 {
  ...
  .well-being-notices {
      ...
      margin-left: 30px; /* Adjust left margin for mobile */
  }

  .well-being-support-card .col-md-6.order-md-1 {
    padding-left: 0; /* Adjust the value to shift the text slightly to the right */
  }

  .well-being-support-card .col-md-6.order-md-2 {
    padding-right: 0; /* Ensure the image stays balanced on the right */
  }
}
...
<section id="well-being-support" class="pt-5 pb-5">
    <div class="container well-being-support-container">
        <h2 class="text-center well-being-support-title mb-4">Well-Being Support</h2>

        <!-- Mental Health Services -->
        <div class="row mb-4 well-being-support-card">
            <div class="col-md-6 order-md-1">
                <img src="../images/illness.png" alt="Mental Health Services" class="img-fluid rounded-circle mb-3">
            </div>
            <div class="col-md-6 order-md-2">
                <h5 class="card-title well-being-support-card-title">Mental Health Services</h5>
                <p class="card-text well-being-support-card-text">Our Mental Health Services provide a safe and supportive environment for students facing emotional and psychological challenges. We offer:</p>
                <ul class="well-being-notices">
                    <li><strong>Individual Counseling:</strong> Meet with a licensed counselor to discuss personal issues and develop coping strategies.</li>
                    <li><strong>Group Therapy:</strong> Participate in group sessions that focus on common concerns such as anxiety, stress, and adjustment issues.</li>
                    <li><strong>Crisis Intervention:</strong> Immediate support for students in crisis situations, available 24/7.</li>
                    <li><strong>Workshops:</strong> Attend workshops on stress management, mindfulness, and self-care strategies.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="row mb-4 well-being-support-card">
            <div class="col-md-6 order-md-2">
                <img src="../images/hotline.png" alt="Wellness Resources" class="img-fluid rounded-circle mb-3">
            </div>
            <div class="col-md-6 order-md-1">
                <h5 class="card-title well-being-support-card-title">Wellness Resources</h5>
                <p class="card-text well-being-support-card-text">Explore a variety of wellness resources designed to promote a healthy lifestyle:</p>
                <ul class="well-being-notices">
                    <li><strong>Fitness Classes:</strong> Join our fitness programs, including yoga, Zumba, and strength training.</li>
                    <li><strong>Nutrition Counseling:</strong> Access nutritional guidance to help you maintain a balanced diet.</li>
                    <li><strong>Stress Relief Programs:</strong> Participate in activities that promote relaxation, such as meditation and breathing exercises.</li>
                </ul>
            </div>
        </div>
        ...
        <div class="row mb-4 well-being-support-card">
            <div class="col-md-6 order-md-1">
                <img src="../images/answer-bro.png" alt="Peer Support Groups" class="img-fluid rounded-circle mb-3">
            </div>
            <div class="col-md-6 order-md-2">
                <h5 class="card-title well-being-support-card-title">Peer Support Groups</h5>
                <p class="card-text well-being-support-card-text">Join our peer support groups where you can connect with fellow students who understand your experiences:</p>
                <ul class="well-being-notices">
                    <li><strong>Stress and Anxiety Group:</strong> Share experiences and coping strategies in a supportive environment.</li>
                    <li><strong>Grief Support Group:</strong> Find comfort and understanding while navigating the process of loss.</li>
                    <li><strong>Academic Stress Group:</strong> Discuss challenges related to academic pressures and find solutions together.</li>
                </ul>
            </div>
        </div>
    </div>
