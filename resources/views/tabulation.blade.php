...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
 ...
 <!-- LOADER -->
  ...
  <section class="tabulation-system-container text-center">
  <!-- Removed slideshow-container to eliminate slide images -->

  <div class="hero-section">
    <h1 class="hero-title">Welcome to the Official SSCF Tabulation System</h1>
    <p class="hero-subtitle">
      Revolutionizing the way pageantry events are scored and managed. Fast, transparent, and efficient.
    </p>
    <a href="{{ route('tabulation-login') }}" class="btn btn-hero">Get Started</a>
  </div>

  <!-- Feature Highlights -->
  <div id="features" class="features-section">
    <h3 class="features-title">Why Use Our Tabulation System?</h3>
    <ul class="features-list text-start">
      <li><strong>Real-Time Scoring:</strong> Scores are calculated instantly and displayed seamlessly.</li>
      <li><strong>User-Friendly Interface:</strong> Easy to navigate for both judges and administrators.</li>
      <li><strong>Detailed Analytics:</strong> Generate reports, view trends, and analyze scores effortlessly.</li>
      <li><strong>Secure and Reliable:</strong> Data is encrypted to maintain confidentiality and integrity.</li>
      <li><strong>Customizable Criteria:</strong> Customize scoring categories to suit your event's unique requirements.</li>
      <li><strong>Multi-Event Support:</strong> Manage multiple pageantry events within a single platform.</li>
      <li><strong>Mobile-Friendly Design:</strong> Access the system seamlessly on any device, anywhere.</li>
    </ul>
  </div>
  ...
  <div class="instructions-section">
    ...
    <ol class="instructions-list text-start">
      <li>Register your event and set up the judging criteria.</li>
      <li>Invite judges to the platform and assign roles.</li>
      <li>During the event, judges input scores in real-time using their devices.</li>
      <li>Monitor the live tabulation dashboard for real-time results.</li>
      <li>Generate comprehensive reports and announce winners with confidence.</li>
    </ol>
  </div>

  @php
    // Fetch only approved pageants
    $pageants = \App\Models\Pageant::where('status', 'approved')->get();
  @endphp

  <!-- Final Results Display Section (Visible Only if There Are Approved Pageants) -->
  @if($pageants->count() > 0)
    <div class="row mt-5">
      <div class="col-md-12">
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body" style="background: #FCE7D9; padding: 30px; border-radius: 0 0 8px 8px;">
            <p class="text-center" style="font-size: 1.1rem; color: #14591D; margin-bottom: 20px;">
              Select a pageant below to view the final results:
            </p>
            <div class="list-group">
              @foreach($pageants as $pageant)
                <a 
                  href="{{ route('user-final-results', $pageant->id) }}" 
                  target="_blank" 
                  class="list-group-item list-group-item-action"
                  style="background: linear-gradient(to right, #E1E289, #FCE7D9); color: #0A210F; margin-bottom: 10px; border-radius: 5px; border: 1px solid #D4D4D4;">
                  <div class="d-flex justify-content-between align-items-center">
                    <span style="font-weight: bold; font-size: 1.2rem;">{{ $pageant->name }}</span>
                    <span class="badge" style="background-color: #14591D; color: #FCE7D9; font-size: 0.9rem; padding: 5px 10px; border-radius: 5px;">
                      View Results
                    </span>
                  </div>
                </a>
  ...
  @else
    <!-- Optional: Display a message when there are no approved pageants -->
    <div class="row mt-5">
      <div class="col-md-12">
        <div class="alert alert-info text-center" role="alert">
          No approved pageants available at the moment. Please check back later.
        </div>
      </div>
    </div>
  @endif
  ...
  <!-- Modal -->
  <div id="infoModal" class="modal" tabindex="-1" style="display: none;">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
          <p>Please note that this tabulation system is exclusively designed for pageantry events. If you have already
             set up your event and need assistance, contact our support team for guidance.</p>
        </div>
        <div class="modal-footer">
...
<!-- Additional Styling for Pageantry Theme -->
<style>
  /* Base Styles */
  body {
    margin: 0;
    padding: 0;
    overflow-x: hidden;
    background: linear-gradient(to bottom, rgb(45, 105, 48), rgb(255, 246, 240));
    font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
    color: #0A210F;
    line-height: 1.6;
  }

  .tabulation-system-container {
    padding: 40px 20px;
    border-radius: 10px;
  ...
  .hero-section {
    background: linear-gradient(to right, #0A210F, #14591D);
    padding: 60px 20px;
    text-align: center;
    color: #FCE7D9;
    border-radius: 10px;
  ...
  /* New Table Styles */
  #managePageantsTable th, #managePageantsTable td {
  ...
  .fa-eye, .fa-edit, .fa-trash-alt, .fa-check, .fa-times {
    margin-right: 5px;
  }
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    // Optionally, you can add functionality to automatically show the modal on page load
