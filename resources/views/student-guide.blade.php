...
<div class="sscf-container sscf-header text-center">
        <div class="sscf-typography">
            <h1>Student Manual</h1>
            <h2>Southern Luzon State University</h2>
            <h2>Supreme Student Council Federation</h2>

            <p>Welcome to the <strong>Supreme Student Council Federation (SSCF)</strong> of Southern Luzon State University. This manual is designed to guide student council members in understanding their <strong>roles, responsibilities</strong>, and <strong>resources</strong> available to maximize their leadership impact.</p>
        </div>
    </div>


    <!-- Structure and Role of SSCF Section -->
    <div class="sscf-container sscf-section">
        <div class="sscf-typography">
            <h3>SSCF Structure and Roles</h3>
            <p>The Supreme Student Council Federation (SSCF) is composed of representatives from various colleges, schools, and departments within Southern Luzon State University. It serves as the highest <strong>policy-making body</strong> and acts as a vital link between the student body and the university administration.</p>
            
            <h4>Roles and Responsibilities</h4>
            <ul>
                <li><strong>President / Student Regent</strong>: Serves as the chief representative of the student body, oversees council operations, and ensures alignment with institutional goals.</li>
                <li><strong>Internal Vice President</strong>: Responsible for internal affairs, ensuring effective communication and collaboration among council members.</li>
                <li><strong>External Vice President</strong>: Handles external partnerships and collaborations, representing the council in various events and initiatives.</li>
                <li><strong>Executive Secretary</strong>: Oversees administrative tasks, maintains official records, prepares minutes of meetings, and ensures smooth execution of council activities.</li>
                <li><strong>Assistant Secretary</strong>: Assists in managing council documentation, meetings, and correspondence to ensure organized operations.</li>
                <li><strong>Treasurer</strong>: Manages SSCF finances, oversees budgeting, and ensures transparency in income-generating projects (IGPs).</li>
                <li><strong>Auditor</strong>: Verifies financial records and ensures the proper utilization of SSCF funds and resources.</li>
                <li><strong>Cultural and Sports Coordinator</strong>: Promotes cultural activities, encourages student participation in sports, and fosters engagement and unity within the student body.</li>
                <li><strong>Communication and Logistics Coordinator</strong>: Manages internal and external communication, ensures efficient information dissemination, and handles logistics for events.</li>
                <li><strong>Education and Research Coordinator</strong>: Advocates for academic excellence, spearheads educational initiatives, and promotes research opportunities for students.</li>
                <li><strong>Student Clubs and Organizations Coordinator</strong>: Collaborates with student organizations, provides guidance, and supports their initiatives and events.</li>
                <li><strong>Finance and IGP Coordinator</strong>: Oversees financial matters and income-generating projects, ensuring sustainable growth and proper resource allocation.</li>
                <li><strong>Audit, Balance, and Logistics Coordinator</strong>: Ensures transparency and accountability in council operations, focusing on logistics and financial balance.</li>
                <li><strong>Health and Environment Coordinator</strong>: Advocates for students' health and promotes environmental sustainability through innovative projects and campaigns.</li>
                <li><strong>Gender and Development Coordinator</strong>: Promotes gender equality and inclusivity by organizing awareness campaigns and support programs for students.</li>
                <li><strong>Community Extension Services & Linkages Coordinator</strong>: Engages with external communities to provide assistance and create meaningful connections beyond the campus.</li>
                <li><strong>Students’ Rights and Welfare Coordinator</strong>: Advocates for the rights and welfare of students, ensuring their voices are heard and addressed.</li>
                <li><strong>Legal Matters & Concerns, ER Coordinator</strong>: Handles legal issues and ensures compliance with institutional policies and regulations.</li>
            </ul>
            
            <h4>Governors (House of Representatives)</h4>
            <p>Composed of governors representing different colleges and campuses to address specific concerns and advocate for their constituents:</p>
            <ul>
                <li>Governor CABHA</li>
                <li>Governor CAg</li>
                <li>Governor CAM</li>
                <li>Governor CAS</li>
                <li>Governor CEn</li>
                <li>Governor CIT</li>
                <li>Governor CTE</li>
                <li>Governor Alabat</li>
                <li>Governor Catanuan</li>
                <li>Governor Gumaca</li>
                <li>Governor Lucena</li>
                <li>Governor Polillo</li>
                <li>Governor Tagkawayan</li>
                <li>Governor Tayabas</li>
                <li>Governor Tiaong</li>
            </ul>
        </div>
    </div>

    <!-- Role of the Student Council Section -->
    <div class="sscf-container sscf-section">
        <div class="sscf-typography">
            <h3>Role of Student Councils</h3>
            <p>Student councils within Southern Luzon State University play a crucial role in representing their peers, advocating for their rights, and promoting student initiatives. Here are the key <strong>responsibilities</strong> of student councils:</p>
            
            <ul>
                <li>Advocate for <strong>student rights</strong> and welfare</li>
                <li>Organize events and programs that benefit the student body</li>
                <li>Collaborate with the university administration on student concerns</li>
                <li>Encourage student involvement in <strong>extracurricular activities</strong></li>
                <li>Foster a sense of community and <strong>leadership</strong> among students</li>
            </ul>
        </div>
    </div>
    ...
    <div class="sscf-container sscf-section">
        <div class="sscf-typography">
            ...
            <p>As students of Southern Luzon State University, you are entitled to the following <strong>rights</strong>:</p>
            
            <ul>
                <li>The right to <strong>quality education</strong></li>
                <li>The right to participate in <strong>university governance</strong></li>
                <li>The right to <strong>freedom of expression</strong> and association</li>
                <li>The right to <strong>fair treatment</strong> and protection from discrimination</li>
                <li>The right to access <strong>campus resources</strong> and facilities</li>
            </ul>
        </div>
    </div>
    ...
    <div class="sscf-container sscf-section">
        <div class="sscf-typography">
            ...
            <p>The SSCF is committed to helping student leaders grow in their roles through <strong>leadership development programs</strong>, workshops, and networking opportunities. Enhance your skills in <strong>communication</strong>, <strong>project management</strong>, and <strong>problem-solving</strong> to become an effective leader.</p>
        </div>
    </div>

    <!-- Contact and Involvement Section -->
    <div class="sscf-container sscf-section">
        <div class="sscf-typography">
            <h3>Get Involved</h3>
            <p>Joining the <strong>Supreme Student Council Federation (SSCF)</strong> allows you to be a voice for the student body, contribute to meaningful initiatives, and create a positive impact on the university community. It’s a platform to hone your <strong>leadership skills</strong> and collaborate with fellow student leaders to bring about change.</p>
        </div>
    </div>
