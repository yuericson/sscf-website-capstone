...
<style>
  ...
  .organization-title {
    ...
    color: #14591D;/* Soft pink color */
    margin-top: -60px; /* Adjust spacing above */
  }

  .title-underline {
    width: 100px; /* Width of underline */
    height: 3px; /* Height of underline */
    background-color: #E1E289; /* Light green color */
    margin: 0.5em auto 20px; /* Center align and spacing */
  }

  .org-chart {
    width: 100%; /* Full width */
    height: auto; /* Maintain aspect ratio */
    border: 2px solid #E1E289; /* Light green border */
  ...
  @media (max-width: 768px) {
    ...
    .title-underline {
      width: 80px; /* Smaller underline for smaller screens */
