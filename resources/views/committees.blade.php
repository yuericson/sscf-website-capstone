...
.committees-header h2, .committees-header h3 {
  border-bottom: 3px solid #14591D;
  display: inline-block;
...
@media (max-width: 768px) {
  ...
  <section id="committees" class="py-5 committees-section">
  <div class="container committees-container">
    <div class="row mb-4">
      <div class="col text-center committees-header">
        <h2>Details of Organizational Structure</h2>
        <p class="lead committees-lead">Learn more about the leadership structure and dedicated committees within the Supreme Student Council Federation</p>
      </div>
    </div>
    ...
    <div class="row mb-4">
      <div class="col text-center committees-header">
        <h3>SSCF Leadership</h3>
        <p>The primary leaders and executives managing the council's operations.</p>
      </div>
    </div>
    <div class="row committees-row">
      <ul class="list-group mb-4">
        <li class="list-group-item">
          SSCF President / Student Regent
          <p class="card-text committees-card-text">Serves as the chief representative of the student body, overseeing council operations and ensuring alignment with institutional goals.</p>
        </li>
      </ul>
      <h4 class="text-center">Executives</h4>
      <ul class="list-group">
        <li class="list-group-item">
          VP Internal
          <p class="card-text committees-card-text">Responsible for internal affairs, ensuring effective communication and collaboration among council members.</p>
        </li>
        <li class="list-group-item">
          VP External
          <p class="card-text committees-card-text">Handles external partnerships and collaborations, representing the council in various events and initiatives.</p>
        </li>
        <li class="list-group-item">
          Assistant Secretary
          <p class="card-text committees-card-text">Assists in managing council documentation, meetings, and correspondence to ensure organized operations.</p>
        </li>
        <li class="list-group-item">
          Executive Secretary
          <p class="card-text committees-card-text">Oversees administrative tasks, maintaining records and ensuring smooth execution of council activities.</p>
        </li>
      </ul>
    </div>
    ...
    <div class="row mb-4">
      <div class="col text-center committees-header">
        <h3>Senate</h3>
        <p>Comprising various committees to ensure the smooth operation of council activities and student welfare initiatives.</p>
      </div>
    </div>
    <div class="row committees-row">
      <!-- Finance and IGP -->
      <div class="col-lg-4 col-md-6 mb-4 committees-col">
        <div class="card h-100 committees-card">
          <div class="card-body committees-card-body">
            <h5 class="card-title committees-card-title">Finance and IGP</h5>
            <p class="card-text committees-card-text">Oversees financial matters and income-generating projects, ensuring sustainable financial growth and proper allocation of resources.</p>
          </div>
        </div>
      </div>
      <!-- Audit, Balance, and Logistics -->
      <div class="col-lg-4 col-md-6 mb-4 committees-col">
        <div class="card h-100 committees-card">
          <div class="card-body committees-card-body">
            <h5 class="card-title committees-card-title">Audit, Balance, and Logistics</h5>
            <p class="card-text committees-card-text">Ensures transparency and accountability in council operations, focusing on logistics and balance management.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4 committees-col">
        <div class="card h-100 committees-card">
          <div class="card-body committees-card-body">
            <h5 class="card-title committees-card-title">Communication and Information</h5>
            <p class="card-text committees-card-text">Manages internal and external communication, ensuring efficient information dissemination across all platforms.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4 committees-col">
        <div class="card h-100 committees-card">
          <div class="card-body committees-card-body">
            <h5 class="card-title committees-card-title">Education and Research</h5>
            <p class="card-text committees-card-text">Focuses on advancing academic development through educational initiatives and research projects that benefit the student body.</p>
          </div>
        </div>
      </div>
      <!-- Culture and Arts -->
      <div class="col-lg-4 col-md-6 mb-4 committees-col">
        <div class="card h-100 committees-card">
          <div class="card-body committees-card-body">
            <h5 class="card-title committees-card-title">Culture and Arts</h5>
            <p class="card-text committees-card-text">Promotes cultural activities, fostering creativity and a sense of heritage within the student community.</p>
          </div>
        </div>
      </div>
      <!-- Sports -->
      <div class="col-lg-4 col-md-6 mb-4 committees-col">
        <div class="card h-100 committees-card">
          <div class="card-body committees-card-body">
            <h5 class="card-title committees-card-title">Sports</h5>
            <p class="card-text committees-card-text">Encourages students' participation in sports activities, fostering physical wellness and teamwork through various programs.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4 committees-col">
        <div class="card h-100 committees-card">
          <div class="card-body committees-card-body">
            <h5 class="card-title committees-card-title">Health and Environment</h5>
            <p class="card-text committees-card-text">Advocates for students' health and promotes environmental sustainability through innovative projects and campaigns.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4 committees-col">
        <div class="card h-100 committees-card">
          <div class="card-body committees-card-body">
            <h5 class="card-title committees-card-title">Gender and Development</h5>
            <p class="card-text committees-card-text">Promotes gender equality and inclusivity by organizing awareness campaigns and support programs for students.</p>
          </div>
        </div>
      </div>
      <!-- Community Extension Services & Linkages -->
      <div class="col-lg-4 col-md-6 mb-4 committees-col">
        <div class="card h-100 committees-card">
          <div class="card-body committees-card-body">
            <h5 class="card-title committees-card-title">Community Extension Services & Linkages</h5>
            <p class="card-text committees-card-text">Engages with external communities to provide assistance and create meaningful connections beyond the campus.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 mb-4 committees-col">
        <div class="card h-100 committees-card">
          <div class="card-body committees-card-body">
            <h5 class="card-title committees-card-title">Students’ Rights and Welfare</h5>
            <p class="card-text committees-card-text">Advocates for the rights and welfare of students, ensuring their voices are heard and addressed.</p>
          </div>
        </div>
      </div>
      <!-- Legal Matters & Concerns, ER -->
      <div class="col-lg-4 col-md-6 mb-4 committees-col">
        <div class="card h-100 committees-card">
          <div class="card-body committees-card-body">
            <h5 class="card-title committees-card-title">Legal Matters & Concerns, ER</h5>
            <p class="card-text committees-card-text">Handles legal issues and ensures compliance with institutional policies and regulations.</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row committees-row">
      <!-- List of Governors -->
      <ul class="list-group">
        <li class="list-group-item">Governor CABHA</li>
        <li class="list-group-item">Governor CAg</li>
        <li class="list-group-item">Governor CAM</li>
        <li class="list-group-item">Governor CAS</li>
        <li class="list-group-item">Governor CEn</li>
        <li class="list-group-item">Governor CIT</li>
        <li class="list-group-item">Governor CTE</li>
        <li class="list-group-item">Governor Alabat</li>
        <li class="list-group-item">Governor Catanuan</li>
        <li class="list-group-item">Governor Gumaca</li>
        <li class="list-group-item">Governor Lucena</li>
        <li class="list-group-item">Governor Polillo</li>
        <li class="list-group-item">Governor Tagkawayan</li>
        <li class="list-group-item">Governor Tayabas</li>
        <li class="list-group-item">Governor Tiaong</li>
      </ul>
    </div>
  </div>
</section>
