...
<div class="main-content" id="mainContent">
    <h2>Sports Registration Dashboard</h2>
    ...
    <div class="mt-2">
        ...
        <table class="table table-bordered table-striped" id="registrationTable">
            ...
            <tbody>
                ...
                @if ($registrations->count() > 0)
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('delete.registration', $registration->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this registration?');">
                                @csrf
                            ...
                            <div class="modal-content">
                                <form action="{{ route('edit.registration', $registration->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="gender_{{ $registration->id }}" class="form-label">Gender</label>
                                            <select class="form-select" id="gender_{{ $registration->id }}" name="gender" required>
                                                ...
                                                <option value="Non-Binary" {{ $registration->gender == 'Non-Binary' ? 'selected' : '' }}>Non-Binary</option>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            <label for="year_level_{{ $registration->id }}" class="form-label">Year Level</label>
                                            <input type="text" class="form-control" id="year_level_{{ $registration->id }}" name="year_level" value="{{ $registration->year_level }}" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="course_{{ $registration->id }}" class="form-label">Course</label>
                                            <input type="text" class="form-control" id="course_{{ $registration->id }}" name="course" value="{{ $registration->course }}" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="college_campus_{{ $registration->id }}" class="form-label">College/Campus</label>
                                            <input type="text" class="form-control" id="college_campus_{{ $registration->id }}" name="college_campus" value="{{ $registration->college_campus }}" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="sports_event_{{ $registration->id }}" class="form-label">Sports Event</label>
                                            <input type="text" class="form-control" id="sports_event_{{ $registration->id }}" name="sports_event" value="{{ $registration->sports_event }}" required>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            @endif
                                            <input type="file" class="form-control" id="image_{{ $registration->id }}" name="image">
                                        </div>
                                    </div>
                ...
                @else
                    <tr>
                        <td colspan="11" class="text-center text-danger fw-bold">No registrations found.</td>
                    </tr>
                @endif
            </tbody>
        </table>
