...
<div class="main-content" id="mainContent">
    <h2>Local Election Dashboard</h2>
                        ...
                        <tbody>
                            @foreach ($voters as $voter)
                                <tr>
                                    ...
                                    <td>{{ $voter->college }}</td>
                                    <td>
                                        <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editVoterModal{{ $voter->id }}">Edit</button>
                                        ...
                                        <form action="{{ route('voters.update', $voter->id) }}" method="POST">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        <label for="student-id-{{ $voter->id }}" class="form-label">Student ID</label>
                                                        <input type="text" class="form-control" id="student-id-{{ $voter->id }}" name="student_id" value="{{ $voter->student_id }}" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="name-{{ $voter->id }}" class="form-label">Name</label>
                                                        <input type="text" class="form-control" id="name-{{ $voter->id }}" name="name" value="{{ $voter->name }}" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="email-{{ $voter->id }}" class="form-label">Email</label>
                                                        <input type="email" class="form-control" id="email-{{ $voter->id }}" name="email" value="{{ $voter->email }}" required>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="college-{{ $voter->id }}" class="form-label">College/Campus</label>
                                                        <input type="text" class="form-control" id="college-{{ $voter->id }}" name="college" value="{{ $voter->college }}" required>
                                                    </div>
                                                </div>
            ...
            <form action="{{ route('voters.store') }}" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="college" class="form-label">College/Campus</label>
