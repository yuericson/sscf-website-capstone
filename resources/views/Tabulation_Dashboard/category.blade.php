...
<div class="main-content p-4" id="mainContent">
    <h2 class="mb-4 border-bottom pb-2">Category Dashboard</h2>
...
<div class="row mt-5">
                    ...
                    <table class="table table-bordered" id="categoriesTable">
                        ...
                        @foreach($categories as $cat)
                            ...
                            <div class="modal fade" id="editCategoryModal{{ $cat->id }}" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('tabulation-category-edit', $cat->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="name{{ $cat->id }}" class="form-label">
                                                        Category Name
                                                    </label>
                            ...
                            <div class="modal fade" id="deleteCategoryModal{{ $cat->id }}" tabindex="-1"
                                 aria-labelledby="deleteCategoryModalLabel{{ $cat->id }}" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form action="{{ route('tabulation-category-delete', $cat->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="deleteCategoryModalLabel{{ $cat->id }}">
                                                    Delete Category
                                                </h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
    ...
    <div class="modal fade" id="addCategoryModal" tabindex="-1" aria-labelledby="addCategoryModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('tabulation-category-add') }}" method="POST">
                    @csrf
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="pageantSelectCategory" class="form-label">Select Event</label>
                            <select class="form-select" name="pageant_id" id="pageantSelectCategory" required>
