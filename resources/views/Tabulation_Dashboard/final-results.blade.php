...
<div class="main-content p-4" id="mainContent">
    <h2 class="mb-4 border-bottom pb-2">Final Result Dashboard</h2>
...
{{-- resources/views/partials/final-results.blade.php --}}
<div class="row mt-5">
    <div class="col-md-12">
        <div class="card mb-4 shadow-sm">
            <div class="card-header text-center"
                 style="background: linear-gradient(to right, #FFC107, #FF8C00); color: white; padding: 20px; border-radius: 8px 8px 0 0;">
                <h4 class="mb-0">Final Results</h4>
            </div>
            <div class="card-body"
                 style="background: #FCE7D9; padding: 30px; border-radius: 0 0 8px 8px;">
                <p class="text-center"
                   style="font-size: 1.1rem; color: #14591D; margin-bottom: 20px;">
                        ...
                        <a href="{{ route('final-results', $pageant->id) }}"
                           ...
                           style="background: linear-gradient(to right, #E1E289, #FCE7D9); color: #0A210F; margin-bottom: 10px; border-radius: 5px; border: 1px solid #D4D4D4; transition: transform 0.3s, background 0.3s;">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="badge"
                                      style="background-color: #14591D; color: #FCE7D9; font-size: 0.9rem; padding: 5px 10px; border-radius: 5px;">
                                    View Results
                                </span>
                            </div>
                        </a>
