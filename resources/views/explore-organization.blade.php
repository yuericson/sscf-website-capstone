...
<style>
/* General styles for the organization container */
.org-content-container {
  max-width: 1200px; /* Limit the width for better readability */
  margin: 0 auto; /* Center the content */
  padding: 20px; /* Add padding around the content */
  background: linear-gradient(145deg, #F6F9F6, #EAF3EA); /* Subtle light gradient */
  border-radius: 15px;
...
.org-title {
  ...
  color: #185F43; /* Primary green color */
...
/* Campus button styles */
.org-campus-btn {
  background-color: #185F43; /* Primary green */
...
.org-campus-btn:hover {
  background-color: #156737; /* Slightly darker green */
...
<div class="org-content-container">
  <h1 class="org-title">Explore an Organization</h1>
  <p class="org-description">
    Get involved and make a difference! Joining an organization within the Supreme Student Council Federation offers a chance to meet new people, develop skills, and contribute to campus life. Here’s how you can reach out to various student clubs and organizations.
  </p>

  <!-- Section for Selecting Campuses -->
  <section class="mt-5">
    <h2 class="org-section-title">Select a Campus</h2>
    <div class="org-campus-buttons">
      <button class="org-campus-btn" onclick="showOrganizationsAndDepartments('SLSU-Tayabas')">SLSU-Tayabas</button>
      <button class="org-campus-btn" onclick="showOrganizationsAndDepartments('SLSU-Lucena')">SLSU-Lucena</button>
      <button class="org-campus-btn" onclick="showOrganizationsAndDepartments('SLSU-Catanauan')">SLSU-Catanauan</button>
      <button class="org-campus-btn" onclick="showOrganizationsAndDepartments('SLSU-Gumaca')">SLSU-Gumaca</button>
      <button class="org-campus-btn" onclick="showOrganizationsAndDepartments('SLSU-Infanta')">SLSU-Infanta</button>
      <button class="org-campus-btn" onclick="showOrganizationsAndDepartments('SLSU-Tiaong')">SLSU-Tiaong</button>
      <button class="org-campus-btn" onclick="showOrganizationsAndDepartments('SLSU-Polillo')">SLSU-Polillo</button>
      <button class="org-campus-btn" onclick="showOrganizationsAndDepartments('SLSU-Tagkawayan')">SLSU-Tagkawayan</button>
      <button class="org-campus-btn" onclick="showOrganizationsAndDepartments('SLSU-Alabat')">SLSU-Alabat</button>
      <button class="org-campus-btn" onclick="showOrganizationsAndDepartments('SLSU-Lucban')">SLSU-Lucban</button>
    </div>
  </section>

  <!-- Dropdown for Selecting Departments -->
  <section class="mt-5" id="departmentSelection" style="display: none;">
    <h2 class="org-section-title">Select a Department</h2>
    <select id="departmentDropdown" class="form-control w-50 mx-auto" onchange="updateOrganizations()">
      ...
      <option value="CABHA">CABHA</option>
      <option value="CAG">CAG</option>
    </select>
  </section>

  <!-- Contact Organizations -->
  <section class="mt-5 org-contact-info">
    <h2 class="org-section-title">How to Contact Organizations</h2>
    <p>
      To express your interest in joining any of the organizations listed below or to ask any questions, please contact them directly using the provided information.
    </p>
  </section>

  <!-- Available Organizations -->
  <section class="mt-5" id="availableOrganizations" style="display: none;">
    <h2 class="org-section-title">Available Organizations</h2>
    <div class="row" id="orgList"></div>
  </section>
</div>

    <!-- JavaScript -->
    <script>
        // Comprehensive Organizations Data
        const allOrganizations = [
            // SLSU-Tayabas Organizations
            {
                title: 'Tayabas Student Council',
                description: 'Leading student initiatives and representing student interests at SLSU-Tayabas.',
                president: 'Name',
                contact: 'tayabas_sc@slsu.edu',
                campus: 'SLSU-Tayabas',
                departments: []
            },
            {
                title: 'Tayabas Cultural Club',
                description: 'Promoting cultural heritage and organizing cultural events.',
                president: 'Name',
                contact: 'tayabas_cc@slsu.edu',
                campus: 'SLSU-Tayabas',
                departments: []
            },
            {
                title: 'Tayabas Environmental Group',
                description: 'Advocating for environmental sustainability and green initiatives.',
                president: 'Name',
                contact: 'tayabas_env@slsu.edu',
                campus: 'SLSU-Tayabas',
                departments: []
            },
            {
                title: 'Tayabas Tech Innovators',
                description: 'Fostering technological innovation and development among students.',
                president: 'Name',
                contact: 'tayabas_tech@slsu.edu',
                campus: 'SLSU-Tayabas',
                departments: []
            },
            {
                title: 'Tayabas Sports Association',
                description: 'Organizing sports events and promoting physical fitness.',
                president: 'Name',
                contact: 'tayabas_sports@slsu.edu',
                campus: 'SLSU-Tayabas',
                departments: []
            },

            // SLSU-Lucena Organizations
            {
                title: 'Lucena Student Government',
                description: 'Representing the voice of students and working collaboratively with university officials.',
                president: 'Name',
                contact: 'lucena_sc@slsu.edu',
                campus: 'SLSU-Lucena',
                departments: ['CIT', 'CEN']
            },
            {
                title: 'Lucena Cultural Arts Club',
                description: 'Showcasing talents and promoting cultural diversity through various artistic expressions.',
                president: 'Name',
                contact: 'lucena_cac@slsu.edu',
                campus: 'SLSU-Lucena',
                departments: ['CAG']
            },
            {
                title: 'Lucena Environmental Society',
                description: 'Promoting sustainability and environmental awareness on campus through various initiatives.',
                president: 'Name',
                contact: 'lucena_env@slsu.edu',
                campus: 'SLSU-Lucena',
                departments: ['CIT']
            },
            {
                title: 'Lucena Tech Innovators Club',
                description: 'Exploring technology and innovation through exciting projects and collaborations.',
                president: 'Name',
                contact: 'lucena_tech@slsu.edu',
                campus: 'SLSU-Lucena',
                departments: ['CIT', 'CAM']
            },
            {
                title: 'Lucena Arts and Media',
                description: 'Engaging students in arts and media production to enhance creative skills.',
                president: 'Name',
                contact: 'lucena_arts@slsu.edu',
                campus: 'SLSU-Lucena',
                departments: ['CAG']
            },

            // SLSU-Catanauan Organizations
            {
                title: 'Catanauan Student Council',
                description: 'Facilitating student representation and engagement in university matters.',
                president: 'Name',
                contact: 'catanauan_sc@slsu.edu',
                campus: 'SLSU-Catanauan',
                departments: []
            },
            {
                title: 'Catanauan Cultural Society',
                description: 'Celebrating cultural diversity through events and activities.',
                president: 'Name',
                contact: 'catanauan_cs@slsu.edu',
                campus: 'SLSU-Catanauan',
                departments: []
            },
            {
                title: 'Catanauan Environmental Alliance',
                description: 'Advocating for environmental protection and sustainable practices.',
                president: 'Name',
                contact: 'catanauan_env@slsu.edu',
                campus: 'SLSU-Catanauan',
                departments: []
            },
            {
                title: 'Catanauan Tech Club',
                description: 'Encouraging technological advancements and student-led tech projects.',
                president: 'Name',
                contact: 'catanauan_tech@slsu.edu',
                campus: 'SLSU-Catanauan',
                departments: []
            },
            {
                title: 'Catanauan Sports Club',
                description: 'Organizing sports activities and promoting team spirit among students.',
                president: 'Name',
                contact: 'catanauan_sports@slsu.edu',
                campus: 'SLSU-Catanauan',
                departments: []
            },

            // SLSU-Gumaca Organizations
            {
                title: 'Gumaca Student Government',
                description: 'Leading student initiatives and representing student interests at SLSU-Gumaca.',
                president: 'Name',
                contact: 'gumaca_sc@slsu.edu',
                campus: 'SLSU-Gumaca',
                departments: []
            },
            {
                title: 'Gumaca Cultural Arts',
                description: 'Promoting cultural heritage through arts and performances.',
                president: 'Name',
                contact: 'gumaca_ca@slsu.edu',
                campus: 'SLSU-Gumaca',
                departments: []
            },
            {
                title: 'Gumaca Environmental Group',
                description: 'Working towards environmental conservation and sustainability.',
                president: 'Name',
                contact: 'gumaca_env@slsu.edu',
                campus: 'SLSU-Gumaca',
                departments: []
            },
            {
                title: 'Gumaca Tech Pioneers',
                description: 'Innovating and developing technology solutions for campus needs.',
                president: 'Name',
                contact: 'gumaca_tech@slsu.edu',
                campus: 'SLSU-Gumaca',
                departments: []
            },
            {
                title: 'Gumaca Sports Association',
                description: 'Facilitating sports events and encouraging active lifestyles.',
                president: 'Name',
                contact: 'gumaca_sports@slsu.edu',
                campus: 'SLSU-Gumaca',
                departments: []
            },

            // SLSU-Infanta Organizations
            {
                title: 'Infanta Student Council',
                description: 'Representing student voices and organizing campus activities.',
                president: 'Name',
                contact: 'infanta_sc@slsu.edu',
                campus: 'SLSU-Infanta',
                departments: []
            },
            {
                title: 'Infanta Cultural Club',
                description: 'Fostering cultural appreciation through diverse programs and events.',
                president: 'Name',
                contact: 'infanta_cc@slsu.edu',
                campus: 'SLSU-Infanta',
                departments: []
            },
            {
                title: 'Infanta Environmental Society',
                description: 'Promoting eco-friendly practices and environmental education.',
                president: 'Name',
                contact: 'infanta_env@slsu.edu',
                campus: 'SLSU-Infanta',
                departments: []
            },
            {
                title: 'Infanta Tech Innovators',
                description: 'Driving technological innovation and supporting tech-driven projects.',
                president: 'Name',
                contact: 'infanta_tech@slsu.edu',
                campus: 'SLSU-Infanta',
                departments: []
            },
            {
                title: 'Infanta Sports Club',
                description: 'Organizing sports competitions and enhancing athletic skills.',
                president: 'Name',
                contact: 'infanta_sports@slsu.edu',
                campus: 'SLSU-Infanta',
                departments: []
            },

            // SLSU-Tiaong Organizations
            {
                title: 'Tiaong Student Government',
                description: 'Championing student interests and coordinating campus initiatives.',
                president: 'Name',
                contact: 'tiaong_sc@slsu.edu',
                campus: 'SLSU-Tiaong',
                departments: []
            },
            {
                title: 'Tiaong Cultural Arts',
                description: 'Celebrating cultural diversity through artistic endeavors.',
                president: 'Name',
                contact: 'tiaong_ca@slsu.edu',
                campus: 'SLSU-Tiaong',
                departments: []
            },
            {
                title: 'Tiaong Environmental Alliance',
                description: 'Advocating for sustainable practices and environmental stewardship.',
                president: 'Name',
                contact: 'tiaong_env@slsu.edu',
                campus: 'SLSU-Tiaong',
                departments: []
            },
            {
                title: 'Tiaong Tech Hub',
                description: 'Encouraging technological exploration and innovation.',
                president: 'Name',
                contact: 'tiaong_tech@slsu.edu',
                campus: 'SLSU-Tiaong',
                departments: []
            },
            {
                title: 'Tiaong Sports Association',
                description: 'Promoting physical fitness and organizing sports events.',
                president: 'Name',
                contact: 'tiaong_sports@slsu.edu',
                campus: 'SLSU-Tiaong',
                departments: []
            },

            // SLSU-Polillo Organizations
            {
                title: 'Polillo Student Council',
                description: 'Leading student activities and representing student interests.',
                president: 'Name',
                contact: 'polillo_sc@slsu.edu',
                campus: 'SLSU-Polillo',
                departments: []
            },
            {
                title: 'Polillo Cultural Club',
                description: 'Promoting cultural awareness and organizing cultural events.',
                president: 'Name',
                contact: 'polillo_cc@slsu.edu',
                campus: 'SLSU-Polillo',
                departments: []
            },
            {
                title: 'Polillo Environmental Group',
                description: 'Working towards environmental conservation and sustainability.',
                president: 'Name',
                contact: 'polillo_env@slsu.edu',
                campus: 'SLSU-Polillo',
                departments: []
            },
            {
                title: 'Polillo Tech Innovators',
                description: 'Fostering technological advancements and student-led tech projects.',
                president: 'Name',
                contact: 'polillo_tech@slsu.edu',
                campus: 'SLSU-Polillo',
                departments: []
            },
            {
                title: 'Polillo Sports Club',
                description: 'Organizing sports events and encouraging active participation.',
                president: 'Name',
                contact: 'polillo_sports@slsu.edu',
                campus: 'SLSU-Polillo',
                departments: []
            },

            // SLSU-Tagkawayan Organizations
            {
                title: 'Tagkawayan Student Council',
                description: 'Representing student voices and coordinating campus initiatives.',
                president: 'Name',
                contact: 'tagkawayan_sc@slsu.edu',
                campus: 'SLSU-Tagkawayan',
                departments: []
            },
            {
                title: 'Tagkawayan Cultural Arts',
                description: 'Encouraging cultural expression through various artistic mediums.',
                president: 'Name',
                contact: 'tagkawayan_ca@slsu.edu',
                campus: 'SLSU-Tagkawayan',
                departments: []
            },
            {
                title: 'Tagkawayan Environmental Society',
                description: 'Promoting eco-friendly practices and environmental education.',
                president: 'Name',
                contact: 'tagkawayan_env@slsu.edu',
                campus: 'SLSU-Tagkawayan',
                departments: []
            },
            {
                title: 'Tagkawayan Tech Club',
                description: 'Driving technological innovation and supporting tech-driven projects.',
                president: 'Name',
                contact: 'tagkawayan_tech@slsu.edu',
                campus: 'SLSU-Tagkawayan',
                departments: []
            },
            {
                title: 'Tagkawayan Sports Association',
                description: 'Facilitating sports events and promoting athletic excellence.',
                president: 'Name',
                contact: 'tagkawayan_sports@slsu.edu',
                campus: 'SLSU-Tagkawayan',
                departments: []
            },

            // SLSU-Alabat Organizations
            {
                title: 'Alabat Student Council',
                description: 'Leading student activities and representing student interests at SLSU-Alabat.',
                president: 'Name',
                contact: 'alabat_sc@slsu.edu',
                campus: 'SLSU-Alabat',
                departments: []
            },
            {
                title: 'Alabat Cultural Society',
                description: 'Promoting cultural heritage and organizing cultural events.',
                president: 'Name',
                contact: 'alabat_cs@slsu.edu',
                campus: 'SLSU-Alabat',
                departments: []
            },
            {
                title: 'Alabat Environmental Group',
                description: 'Advocating for environmental sustainability and green initiatives.',
                president: 'Name',
                contact: 'alabat_env@slsu.edu',
                campus: 'SLSU-Alabat',
                departments: []
            },
            {
                title: 'Alabat Tech Innovators',
                description: 'Fostering technological innovation and development among students.',
                president: 'Name',
                contact: 'alabat_tech@slsu.edu',
                campus: 'SLSU-Alabat',
                departments: []
            },
            {
                title: 'Alabat Sports Club',
                description: 'Organizing sports events and promoting physical fitness.',
                president: 'Name',
                contact: 'alabat_sports@slsu.edu',
                campus: 'SLSU-Alabat',
                departments: []
            },

            // SLSU-Lucban Organizations
            {
                title: 'Lucban Student Government',
                description: 'Representing the voice of students and working collaboratively with university officials.',
                president: 'Name',
                contact: 'lucban_sg@slsu.edu',
                campus: 'SLSU-Lucban',
                departments: ['CIT', 'CEN']
            },
            {
                title: 'Lucban Cultural Arts Club',
                description: 'Showcasing talents and promoting cultural diversity through various artistic expressions.',
                president: 'Name',
                contact: 'lucban_cac@slsu.edu',
                campus: 'SLSU-Lucban',
                departments: ['CAG']
            },
            {
                title: 'Lucban Environmental Society',
                description: 'Promoting sustainability and environmental awareness on campus through various initiatives.',
                president: 'Name',
                contact: 'lucban_env@slsu.edu',
                campus: 'SLSU-Lucban',
                departments: ['CIT']
            },
            {
                title: 'Lucban Tech Innovators Club',
                description: 'Exploring technology and innovation through exciting projects and collaborations.',
                president: 'Name',
                contact: 'lucban_tech@slsu.edu',
                campus: 'SLSU-Lucban',
                departments: ['CIT', 'CAM']
            },
            {
                title: 'Lucban Arts and Media',
                description: 'Engaging students in arts and media production to enhance creative skills.',
                president: 'Name',
                contact: 'lucban_arts@slsu.edu',
                campus: 'SLSU-Lucban',
                departments: ['CAG']
            }
        ];

        function showOrganizationsAndDepartments(campus) {
            const organizationsSection = document.getElementById('availableOrganizations');
            ...
            departmentSelection.style.display = campus === 'SLSU-Lucban' ? 'block' : 'none';

            // Clear previous organizations
            orgList.innerHTML = '';
            departmentDropdown.selectedIndex = 0; // Reset dropdown

            // Filter organizations based on the selected campus
            const filteredOrganizations = allOrganizations.filter(org => org.campus === campus);
            ...
            if (filteredOrganizations.length > 0) {
                    ...
                    orgList.innerHTML += `
                        <div class="col-md-6 mb-4">
                            <div class="card h-100 org-card">
                                <img src="../images/isit.jpg" class="card-img-top org-card-img" alt="${org.title}">
                                <div class="card-body">
                                    <h5 class="card-title">${org.title}</h5>
                                    <p class="card-text">${org.description}</p>
                                    <p><strong>President:</strong> ${org.president}</p>
                                    <p><strong>Contact:</strong> <a href="mailto:${org.contact}">${org.contact}</a></p>
                                </div>
                            </div>
                        </div>
                    `;
                ...
                orgList.innerHTML = `
                    <div class="col-12 text-center">
                        <p class="text-muted">No organizations available for the selected campus.</p>
                    </div>
                `;
            }
        ...
        function updateOrganizations() {
            ...
            const orgList = document.getElementById('orgList');
            const campus = 'SLSU-Lucban'; // Assuming campus selected is SLSU-Lucban for department filtering

            // Clear previous organizations
            orgList.innerHTML = '';

            // Filter organizations based on the selected department
            const filteredOrganizations = allOrganizations.filter(org => 
                org.campus === campus && org.departments.includes(selectedDepartment)
            );
            ...
            if (filteredOrganizations.length > 0) {
                ...
                orgList.innerHTML = `
                    <div class="col-12 text-center">
                        <p class="text-muted">No organizations available for the selected department.</p>
                    </div>
                `;
            }

            // Scroll to the organizations section
            document.getElementById('availableOrganizations').scrollIntoView({ behavior: 'smooth' });
        }
    </script>
